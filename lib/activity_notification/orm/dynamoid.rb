...
module Dynamoid # :nodoc: all
  ...
  module Criteria
    ...
    class Chain
      ...
      # Selects filtered notifications by association type.
      # @scope class
      # @param [String] name     Association name
      ...
      # Selects filtered notifications by association type and id.
      # @scope class
      # @param [String] name     Association name
      # @param [Object] type     Association type
      ...
      # @return [Dynamoid::Criteria::Chain] Database query of notifications ordered by latest first
      def latest_order
      ...
      # It uses sort key of Global Secondary Index in DynamoDB tables.
      # @return [Dynamoid::Criteria::Chain] Database query of notifications ordered by earliest first
      def earliest_order
      ...
      # @return [Array] Database query of subscriptions ordered by latest subscribed_at first
      ...
      # @return [Array] Database query of subscriptions ordered by earliest subscribed_at first
      ...
      # @return [Array] Database query of subscriptions ordered by key name
      def key_order
        # order(key: :asc)
